...
float Speed1_PID(float target,float feedback) 
{
    ...
    if(speed1_error < 1 && speed1_error > -1) speed1_error = 0;// PID control with dead zone
...
float Speed2_PID(float target,float feedback) 
{
    ...
    if(speed2_error < 1 && speed2_error > -1) speed2_error = 0;// PID control with dead zone
...
float Speed3_PID(float target,float feedback) 
{
    ...
    if(speed3_error < 1 && speed3_error > -1) speed3_error = 0;// PID control with dead zone
...
float Speed4_PID(float target,float feedback) 
{
    ...
    if(speed4_error < 1 && speed4_error > -1) speed4_error = 0;// PID control with dead zone
...
float Angle_PID_Realize(float target, float feedback) 
{
    ...
    if(Angle_error < 2 && Angle_error > -2) Angle_error = 0;// PID control with dead zone
