...
float Speed1_PID(float target,float feedback)
{
    ...
    if(speed1_error < 2 && speed1_error > -2) speed1_error = 0;// PID with dead zone
...
float Speed2_PID(float target,float feedback)
{
    ...
    if(speed2_error < 2 && speed2_error > -2) speed2_error = 0;// PID with dead zone
...
float Speed3_PID(float target,float feedback)
{
    ...
    if(speed3_error < 2 && speed3_error > -2) speed3_error = 0;// PID with dead zone
...
float Speed4_PID(float target,float feedback)
{
    ...
    if(speed4_error < 2 && speed4_error > -2) speed4_error = 0;// PID with dead zone
