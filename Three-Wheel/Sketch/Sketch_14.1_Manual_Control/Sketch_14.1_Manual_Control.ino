/****************************************************************************
  Filename    : Sketch_13.1_Manual_Control
  Description : Use Raspberry Pi Pico implement the Manual_Control of the car
...
int angle_out = 0, speed_out = 0, speed1val, speed2val, speed3val, angle_state, angle, angle_flag, angle_a_out;

extern int encoder1, encoder2, encoder3;
