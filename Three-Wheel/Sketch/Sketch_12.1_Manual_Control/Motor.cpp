...
int v1,v2,v3,vx,vy,pid_v1,pid_v2,pid_v3,angle_v,angle_Ultrasonic,Ultrasonic_speed,Ultrasonic_index,Ultrasonic_mutex = 0,Ultrasonic_state,Ultrasonic_angle,Ultrasonic_delay;
int pid1,pid2,pid3;
int a1,b1,a2,b2,a3,b3,turn_output,turn_a1,turn_b1,turn_a2,turn_b2,turn_a3,turn_b3,turn_a4,turn_b4;
float L = 0.06;
...
{
  // Calculate the decomposition velocity of the total velocity of the car on the coordinate axis
  vx =  - speed_v * sin ( speed_a * PI / 180 );
  vy =    speed_v * cos ( speed_a * PI / 180 );
  // When the joystick is on the left, the car rotates in reverse
  ...
  // Motor limiting and motor output redirection
  Motor_direction();
}