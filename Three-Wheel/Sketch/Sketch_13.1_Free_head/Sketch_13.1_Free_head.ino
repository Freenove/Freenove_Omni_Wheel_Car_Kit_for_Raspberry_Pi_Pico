/************************************************************************
  ...
  Description : Use Raspberry Pi Pico implement the Free mode of the car
...
int state_counter = 0, state = 0, num, turn_speed, turn_location, turn_conter, angle_temp;
...
int imu_state = 0, angle_flag, angle_state = 0, angle_flagstate = 0;
