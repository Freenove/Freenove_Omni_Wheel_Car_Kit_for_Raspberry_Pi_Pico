...
.. image:: ../../codes/_static/imgs/20_Bluetooth_Car/Chapter20_00.png
    :align: center
...
.. literalinclude:: ../../../freenove_Kit/Three-Wheel/Sketch/Sketch_18.1_BlueTooth_car/Sketch_18.1_BlueTooth_car.ino
    :linenos:
    :language: c
    :dedent:

After compiling and uploading the sketch, you can control the car's modes and functionalities with the phone app via Bluetooth. To install the APP, please refer to :ref:`fnk0097/codes/three_wheel/freenove_app:freenove app`
