...
.. math:: 
    ...
    &\boldsymbol{v_2 = \cos 60^\circ \cdot V_x}
    
    &\boldsymbol{v_3 = \cos 60^\circ \cdot V_x}

.. image:: ../../codes/_static/imgs/13_Kinematic_Analysis/Chapter13_02.png
    :align: center
...
.. math:: 
    ...
    &\boldsymbol{v_2 = -\sin 60^\circ \cdot V_y}
    
    &\boldsymbol{v_3 = \sin 60^\circ \cdot V_y}

.. image:: ../../codes/_static/imgs/13_Kinematic_Analysis/Chapter13_03.png
    :align: center
...
.. image:: ../../codes/_static/imgs/13_Kinematic_Analysis/Chapter13_04.png
    :align: center
...
.. math:: 
    ...
    &\boldsymbol{v_2 = \cos 60^\circ \cdot V_x - \sin 60^\circ \cdot V_y + angle_v} 

    &\boldsymbol{v_3 = \cos 60^\circ \cdot V_x + \sin 60^\circ \cdot V_y + angle_v}
...
.. image:: ../../codes/_static/imgs/13_Kinematic_Analysis/Chapter13_05.png
    :align: center
...
For this chapter, we use the assembled car. Please refer to :ref:`fnk0097/codes/three_wheel/1_car_assembly:chapter 1 car assembly` for the detailed assembly process.

.. image:: ../../codes/_static/imgs/13_Kinematic_Analysis/Chapter13_06.png
    :align: center

Sketch
*********************************

Next, we download the code to Raspberry Pi Pico (W) to examine the attitude calculation. Open **"Sketch_11.1_Kinematic_analysis"** folder under **"Freenove_Omni_Wheel_Car_Kit_for_Raspberry_Pi_Pico\\Three-Wheel\\Sketches"** and double-click **"Sketch_11.1_Kinematic_analysis.ino"**. 
...
.. literalinclude:: ../../../freenove_Kit/Three-Wheel/Sketch/Sketch_11.1_Kinematic_analysis/Sketch_11.1_Kinematic_analysis.ino
   :linenos:
   :language: c
   :dedent:
