...
Next, we will download the code to Raspberry Pi Pico (W) to test the LED. Open the folder "Sketch_05.1_LED" in the "Freenove_Omni_Wheel_Car_Kit_for_Raspberry_Pi_Pico\\Three-Wheel\\Sketches" and then double click "Sketch_05.1_LED.ino".
...
.. literalinclude:: ../../../freenove_Kit/Three-Wheel/Sketch/Sketch_05.1_LED/Sketch_05.1_LED.ino
    :linenos:
    :language: c
    :dedent:
