...
Next, we download the code to Raspberry Pi Pico (W) to test the motor. Open "Sketch_01.1_Serial" folder under "Freenove_Omni_Wheel_Car_Kit_for_Raspberry_Pi_Pico\\Four-Wheel\\Sketch" and double-click "Sketch_01.1\_ Serial.ino".
...
.. literalinclude:: ../../../freenove_Kit/Four-Wheel/Sketch/Sketch_01.1_Serial/Sketch_01.1_Serial.ino
  :linenos:
  :language: c
  :dedent:
