...
Open "Sketch_06.1_Gyroscope" folder in "Freenove_Omni_Wheel_Car_Kit_for_Raspberry_Pi_Pico\\Four-Wheel\\Sketches" and then double-click "Sketch_06.1_Gyroscope.ino".
...
.. literalinclude:: ../../../freenove_Kit/Four-Wheel/Sketch/Sketch_06.1_Gyroscope/Sketch_06.1_Gyroscope.ino
    :linenos:
    :language: c
    :dedent:
